...
from TPsource.executor.abstract_executor import AbstractExecutor
from TPsource.utils import get_evaluator, ensure_dir
...
class TrafficStateExecutor(AbstractExecutor):
    def __init__(self, config, model, data_feature):
        ...
        self.cache_dir = './TPsource/cache/{}/model_cache'.format(self.exp_id)
        self.evaluate_res_dir = './TPsource/cache/{}/evaluate_cache'.format(self.exp_id)
        self.summary_writer_dir = './TPsource/cache/{}/'.format(self.exp_id)
        ...
        self.l2_reg = self.config.get('l2_reg', 0)
        self.l2_reg = torch.tensor(self.l2_reg).to(self.device)
